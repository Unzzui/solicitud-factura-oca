...
export default function FacturaManualForm({ onAgregarFactura, onActualizarFactura, onCerrar, facturaEditar }: FacturaManualFormProps) {
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
      {/* Header */}
      <div className={`bg-gradient-to-r ${modoEdicion ? 'from-amber-500 to-amber-400' : 'from-oca-blue to-oca-blue-light'} px-6 py-4`}>
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-lg font-semibold text-white">{modoEdicion ? 'Editar Factura' : 'Agregar Factura Manual'}</h3>
              <p className="text-white/70 text-sm">{modoEdicion ? 'Modifique los datos de la factura' : 'Complete los datos de la factura'}</p>
            </div>
          </div>
          <button
            onClick={onCerrar}
      ...
      <form onSubmit={handleSubmit} className="p-6">
        ...
        <div className="mb-6">
          <h4 className="text-sm font-semibold text-gray-500 uppercase tracking-wide mb-4 flex items-center gap-2">
            <span className="w-6 h-6 bg-oca-blue text-white rounded-full flex items-center justify-center text-xs">1</span>
            Datos del Cliente
          </h4>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            {empresaSeleccionada && (
              <div className="animate-fade-in">
                ...
                <div className="px-4 py-2.5 bg-oca-blue-lighter border border-oca-blue/20 rounded-lg text-gray-800 font-medium">
        ...
        <div className="mb-6">
          <h4 className="text-sm font-semibold text-gray-500 uppercase tracking-wide mb-4 flex items-center gap-2">
            <span className="w-6 h-6 bg-oca-blue text-white rounded-full flex items-center justify-center text-xs">2</span>
            Ubicación y Giro
          </h4>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="md:col-span-2">
              ...
              <input
                ...
                className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-oca-blue focus:border-oca-blue"
              />
            </div>
            <div>
        ...
        <div className="mb-6">
          <h4 className="text-sm font-semibold text-gray-500 uppercase tracking-wide mb-4 flex items-center gap-2">
            <span className="w-6 h-6 bg-oca-blue text-white rounded-full flex items-center justify-center text-xs">3</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder="División ejemplo"
                className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-oca-blue focus:border-oca-blue"
              />
            </div>
            <div className="md:col-span-3">
              <label className="block text-sm font-medium text-gray-700 mb-1">Detalle (OT)</label>
              <input
                type="text"
                value={detalle}
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Orden de Compra (OC)</label>
              <input
                type="text"
                value={ordenCompra}
                onChange={(e) => setOrdenCompra(e.target.value)}
                placeholder="OC 12345678"
                className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-oca-blue focus:border-oca-blue"
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">HES</label>
              <input
                type="text"
                value={hes}
                onChange={(e) => setHes(e.target.value)}
                placeholder="HES 1234567890"
                className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-oca-blue focus:border-oca-blue"
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Atención Sr.</label>
              <input
                type="text"
                value={atencionSr}
        ...
        <div className="mb-6">
          <h4 className="text-sm font-semibold text-gray-500 uppercase tracking-wide mb-4 flex items-center gap-2">
            <span className="w-6 h-6 bg-oca-blue text-white rounded-full flex items-center justify-center text-xs">4</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-oca-blue focus:border-oca-blue text-lg font-semibold"
              />
            </div>
            <div>
